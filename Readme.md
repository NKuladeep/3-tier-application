...
#  3-TIER DEPLOYMENT (WEB SERVER + APP SERVER + MYSQL DB SERVER) IN UBUNTU 
...
```
git clone https://github.com/NKuladeep/3-tier
cd 3_tier/app_server
```
...
```
git clone https://github.com/NKuladeep.git
cd 3-tier_App/web_server
```
